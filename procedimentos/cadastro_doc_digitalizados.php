...
$arquivo=$_FILES['arquivo']['name'];
			...
			$_UP['pasta'] = '../documentos/Digitalizados/';
...
$data		= date('Y-m-d');
$arquivo=$_FILES['arquivo']['name'];		
$sql = "INSERT INTO docDigitalizados(descricao,tipo,responsavel,dataCadastro,arquivo)VALUES('$dados[0]','$dados[1]','$dados[2]','$data','$arquivo')";
 $sql = $pdo->query($sql);
