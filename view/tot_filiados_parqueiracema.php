...
$arquivo='Membros_Novo_Parque_Iracema.xls';

$html='';
$html.='<table border="1">';
$html.='<tr>';
$html.='<td colspan="12">Total Membros - Novo_Parque_Iracema</td>';
$html.='</tr>';
...
//Selecionar todos os itens da tabela 
		  ...
		  $sql = " SELECT * FROM filiado WHERE congregacao = 'NOVO PARQUE IRACEMA'";
		  $sql = $pdo->query($sql);
